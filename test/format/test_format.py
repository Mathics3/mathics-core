...
all_test = {
    ...
    "Graphics[{Text[a^b,{0,0}]}]": {
        ...
        "mathml": {
            ...
            "System`InputForm": r"<mrow><mi>Graphics</mi> <mo>[</mo> <mrow><mo>{</mo> <mrow><mi>Text</mi> <mo>[</mo> <mrow><mrow><mi>a</mi> <mo>^</mo> <mi>b</mi></mrow> <mtext>,&nbsp;</mtext> <mrow><mo>{</mo> <mrow><mtext>0</mtext> <mtext>,&nbsp;</mtext> <mtext>0</mtext></mrow> <mo>}</mo></mrow></mrow> <mo>]</mo></mrow> <mo>}</mo></mrow> <mo>]</mo></mrow>",
            "System`OutputForm": '<mglyph width="294px" height="350px" src="data:image/svg+xml;base64,"/>',
        },
        "latex": {
            "System`StandardForm": '\n\\begin{asy}\nusepackage("amsmath");\nsize(4.9cm, 5.8333cm);\n\n// InsetBox\nlabel("$a^b$", (147.0,175.0), (0,0), rgb(0, 0, 0));\n\nclip(box((136.5,162.5), (157.5,187.5)));\n\n\\end{asy}\n',
            "System`TraditionalForm": '\n\\begin{asy}\nusepackage("amsmath");\nsize(4.9cm, 5.8333cm);\n\n// InsetBox\nlabel("$a^b$", (147.0,175.0), (0,0), rgb(0, 0, 0));\n\nclip(box((136.5,162.5), (157.5,187.5)));\n\n\\end{asy}\n',
            "System`InputForm": "\\text{Graphics}\\left[\\left\\{\\text{Text}\\left[a{}^{\wedge}b, \\left\\{0, 0\\right\\}\\right]\\right\\}\\right]",
            "System`OutputForm": '\n\\begin{asy}\nusepackage("amsmath");\nsize(4.9cm, 5.8333cm);\n\n// InsetBox\nlabel("$a^b$", (147.0,175.0), (0,0), rgb(0, 0, 0));\n\nclip(box((136.5,162.5), (157.5,187.5)));\n\n\\end{asy}\n',
        },
    },
    "TableForm[{Graphics[{Text[a^b,{0,0}]}], Graphics[{Text[a^b,{0,0}]}]}]": {
        ...
        "mathml": {
            ...
            "System`TraditionalForm": '<mtable columnalign="center">\n<mtr><mtd columnalign="center"><mglyph width="147px" height="175px" src="data:image/svg+xml;base64,"/></mtd></mtr>\n<mtr><mtd columnalign="center"><mglyph width="147px" height="175px" src="data:image/svg+xml;base64,"/></mtd></mtr>\n</mtable>',
            "System`InputForm": r"<mrow><mi>TableForm</mi> <mo>[</mo> <mrow><mo>{</mo> <mrow><mrow><mi>Graphics</mi> <mo>[</mo> <mrow><mo>{</mo> <mrow><mi>Text</mi> <mo>[</mo> <mrow><mrow><mi>a</mi> <mo>^</mo> <mi>b</mi></mrow> <mtext>,&nbsp;</mtext> <mrow><mo>{</mo> <mrow><mtext>0</mtext> <mtext>,&nbsp;</mtext> <mtext>0</mtext></mrow> <mo>}</mo></mrow></mrow> <mo>]</mo></mrow> <mo>}</mo></mrow> <mo>]</mo></mrow> <mtext>,&nbsp;</mtext> <mrow><mi>Graphics</mi> <mo>[</mo> <mrow><mo>{</mo> <mrow><mi>Text</mi> <mo>[</mo> <mrow><mrow><mi>a</mi> <mo>^</mo> <mi>b</mi></mrow> <mtext>,&nbsp;</mtext> <mrow><mo>{</mo> <mrow><mtext>0</mtext> <mtext>,&nbsp;</mtext> <mtext>0</mtext></mrow> <mo>}</mo></mrow></mrow> <mo>]</mo></mrow> <mo>}</mo></mrow> <mo>]</mo></mrow></mrow> <mo>}</mo></mrow> <mo>]</mo></mrow>",
            "System`OutputForm": '<mtable columnalign="center">\n<mtr><mtd columnalign="center"><mglyph width="147px" height="175px" src="data:image/svg+xml;base64,"/></mtd></mtr>\n<mtr><mtd columnalign="center"><mglyph width="147px" height="175px" src="data:image/svg+xml;base64,"/></mtd></mtr>\n</mtable>',
        },
        "latex": {
            ...
            "System`InputForm": "\\text{TableForm}\\left[\\left\\{\\text{Graphics}\\left[\\left\\{\\text{Text}\\left[a{}^{\wedge}b, \\left\\{0, 0\\right\\}\\right]\\right\\}\\right], \\text{Graphics}\\left[\\left\\{\\text{Text}\\left[a{}^{\wedge}b, \\left\\{0, 0\\right\\}\\right]\\right\\}\\right]\\right\\}\\right]",
...
def test_makeboxes_mathml(str_expr, str_expected, form, msg):
    result = session.evaluate(str_expr)
    format_result = result.format(session.evaluation, form)
    str_result = format_result.boxes_to_mathml(evaluation=session.evaluation)
    if msg:
        assert str_result == str_expected, msg
    else:
