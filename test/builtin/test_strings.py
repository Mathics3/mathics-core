...
@pytest.mark.parametrize(
    ...
    [
        (r"\.78\.79\.7A", "xyz", "variable name using octal characters"),
        (r"\:0078\:0079\:007A", "xyz", "variable name using octal characters"),
        (r"\101\102\103\061\062\063", "ABC123", "variable name using octal characters"),
    ],
)
