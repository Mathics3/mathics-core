...
SORTED_SYMBOLS_BY_PRECEDENCE = [
    ...
    "DoubleRightTee",
    "DoubleLeftTee",
    # In WMA, RoundImplies behaviour
    # is not compatible with the WMA precedence...
    # Let's just invert the order..
    "RoundImplies",
    "Or",
    "And",
    "Not",
    ...
    "DoubleVerticalBar",
    # In WMA, LessSlantEqual and GreaterSlantEqual
    # reports the default value for Precedence,
    ...
    "Square",
    "DifferentialD",
    # In WMA, "Del" has the same precedence
    # as "DifferentialD" and "CapitalDifferntialD"
    # "Del",
    ...
    "DoubleDownArrow",
    "Power",
    # In WMA, these operators does not have
    # a true Pre/Postfix form
...
def no_test_precedence_values(symbol, prec):
    """
