% -*- latex -*-
%
% This is ae top-level LaTeX file to be used in testing TeX building.
% It includes testing.tex which you are to provide.
% That file contains the things you want to test out, such as
% asymptote examples.
%
% Often you start out with the auto-generated file "documentation.tex"
% and then strip it down to the parts you want to scrutenize
% The results of running this test are put in mathics-test.pdf
%
% To build this:
