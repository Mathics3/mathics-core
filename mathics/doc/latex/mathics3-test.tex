% -*- latex -*-
%
% This is the top-level LaTeX file that can be used to debug problems in
% Mathics3 Book (Tutorial + Reference), which is quite large and unwieldy.
%
% Instead do this. First:
%  cp testing-sample.tex testing.tex
%  make documentation.tex
%
% Then take extract problem LaTeX from documentation.tex and put it in testing.tex
%
% Finally build test-mathics3.pdf:
%    make test-mathics3.pdf
%
% The bulk of the LaTeX is in file documentation.tex, which is
...
% NOTE: most of this file is a duplicate of mathics3.tex.
% Changes here should be coordinated with mathics3.tex.
...
%%%
%%% THIS SHOULD BE THE ONLY LINE THAT DIFFERS BETWEEN HERE AND mathics3.tex
%%%
\input{testing.tex}
