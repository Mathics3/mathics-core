...
class FixedPoint(Builtin):
    ...
    summary_text = "nests until a fixed point is reached returning the last expression"
...
class FixedPointList(Builtin):
    ...
    summary_text = "nests until a fixed point is reached return a list "
...
class Interrupt(Builtin):
    ...
    summary_text = "interrupts the evaluation and return '$Aborted'"
...
class Switch(Builtin):
    ...
    summary_text = "switchs based on a value, with patterns allowed"
