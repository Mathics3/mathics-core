...
from mathics.core.builtin import NoMeaningPrefixOperator
...
def add_no_meaning_prefix_operators():
    add_no_meaning_builtins(
        "prefix", "Prefix", NoMeaningPrefixOperator, modules[__name__]
    )


add_no_meaning_prefix_operators()
