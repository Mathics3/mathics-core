...
"""
Basic formatting and notation builtins.
"""
...
from mathics.core.attributes import hold_all_complete as A_HOLD_ALL_COMPLETE
from mathics.core.element import BaseElement, BoxElement
from mathics.core.formatter import _BoxedString, format_element, number_form
...
def parenthesize(
    precedence: int, element: BaseElement, element_boxes: tuple, when_equal: bool
) -> BoxElement:
...
def make_boxes_infix(
    elements: tuple, ops: list, precedence, grouping: str, form: Symbol
) -> BaseElement:
    result = []
