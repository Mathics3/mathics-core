...
SymbolAxesStyle = Symbol("System`AxesStyle")
SymbolBackground = Symbol("Sytem`Background")
...
SymbolBoxForms = Symbol("System`$BoxForms")
...
SymbolButtonBox = Symbol("System`ButtonBox")
...
SymbolElement = Symbol("System`Element")
...
SymbolFileExtension = Symbol("System`FileExtension")
SymbolFileFormat = Symbol("System`FileFormat")
SymbolFindClusters = Symbol("System`FindClusters")
SymbolFindFile = Symbol("System`FindFile")
SymbolFirst = Symbol("System`First")
SymbolFloor = Symbol("System`Floor")
SymbolFormBox = Symbol("System`FormBox")
...
SymbolGraphicsComplexBox = Symbol("System`GraphicsComplexBox")
...
SymbolInformationData = Symbol("System`InformationData")
SymbolInformationDataGrid = Symbol("System`InformationDataGrid")
...
SymbolManipulateBox = Symbol("System`ManipulateBox")
...
SymbolNand = Symbol("System`Nand")
SymbolNeeds = Symbol("System`Needs")
SymbolNor = Symbol("System`Nor")
...
SymbolOpenWrite = Symbol("System`OpenWrite")
...
SymbolPaneBox = Symbol("System`PaneBox")
SymbolParentForm = Symbol("System`ParentForm")
...
SymbolPlotRangePadding = Symbol("System`PlotRangePadding")
...
SymbolPolygon3DBox = Symbol("Symbol`Polygon3DBox")
SymbolPolygonBox = Symbol("Symbol`PolygonBox")
...
SymbolRationals = Symbol("System`Rationals")
...
SymbolStringToStream = Symbol("System`StringToStream")
...
SymbolWriteString = Symbol("System`WriteString")
